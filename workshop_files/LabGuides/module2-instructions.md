...
```Powershell
Write-Host "VNet ID: $AKS_VNET_ID"
Write-Host "Nodes Subnet ID: $NODES_SUBNET_ID"
Write-Host "Pods Subnet ID: $PODS_SUBNET_ID"
```
...
```Powershelle
Write-Host "Workload Image name: $($ACR_NAME).azurcr.io/$($SAMPLE_IMAGE_NAME)"
```
